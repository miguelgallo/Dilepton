...
int CompHistos()
{
        ...
        double sum_integral_mass = integral_h_elastic_x130_mass + integral_h_elastic_x130_div30_mass + integral_h_elastic_x140_div30_mass + integral_h_elastic_x150_div30_mass  + integral_h_singlediss_mass;
        ...
        double sum_integral_pt = integral_h_elastic_x130_pt + integral_h_elastic_x130_div30_pt + integral_h_elastic_x140_div30_pt + integral_h_elastic_x150_div30_pt  + integral_h_singlediss_pt;
        ...
        double sum_integral_y = integral_h_elastic_x130_y + integral_h_elastic_x130_div30_y + integral_h_elastic_x140_div30_y + integral_h_elastic_x150_div30_y  + integral_h_singlediss_y;
        ...
        double sum_integral_xil = integral_h_elastic_x130_xil + integral_h_elastic_x130_div30_xil + integral_h_elastic_x140_div30_xil + integral_h_elastic_x150_div30_xil  + integral_h_singlediss_xil;
        ...
        double sum_integral_xir = integral_h_elastic_x130_xir + integral_h_elastic_x130_div30_xir + integral_h_elastic_x140_div30_xir + integral_h_elastic_x150_div30_xir  + integral_h_singlediss_xir;
        ...
        h_singlediss_clone_xir->Scale(scale_data_xir);
	     ...
	     h_elastic_x130_clone_mass->Add(h_elastic_x130_div30_clone_mass);
		  h_elastic_x130_clone_mass->Add(h_elastic_x140_div30_clone_mass);
		  h_elastic_x130_clone_mass->Add(h_elastic_x150_div30_clone_mass);
	     h_elastic_x130_clone_pt->Add(h_elastic_x130_div30_clone_pt);
		  h_elastic_x130_clone_pt->Add(h_elastic_x140_div30_clone_pt);
		  h_elastic_x130_clone_pt->Add(h_elastic_x150_div30_clone_pt);
	     h_elastic_x130_clone_y->Add(h_elastic_x130_div30_clone_y);
		  h_elastic_x130_clone_y->Add(h_elastic_x140_div30_clone_y);
		  h_elastic_x130_clone_y->Add(h_elastic_x150_div30_clone_y);
	     h_elastic_x130_clone_xil->Add(h_elastic_x130_div30_clone_xil);
		  h_elastic_x130_clone_xil->Add(h_elastic_x140_div30_clone_xil);
		  h_elastic_x130_clone_xil->Add(h_elastic_x150_div30_clone_xil);
	     h_elastic_x130_clone_xir->Add(h_elastic_x130_div30_clone_xir);
		  h_elastic_x130_clone_xir->Add(h_elastic_x140_div30_clone_xir);
		  h_elastic_x130_clone_xir->Add(h_elastic_x150_div30_clone_xir);
	
		  THStack hs_mass("hs_mass","");
		  hs_mass.Add(h_elastic_x130_clone_mass);
		  hs_mass.Add(h_singlediss_clone_mass);
		  THStack hs_pt("hs_pt","");
		  hs_pt.Add(h_elastic_x130_clone_pt);
		  hs_pt.Add(h_singlediss_clone_pt);
		  THStack hs_y("hs_y","");
		  hs_y.Add(h_elastic_x130_clone_y);
		  hs_y.Add(h_singlediss_clone_y);
		  THStack hs_xil("hs_xil","");
		  hs_xil.Add(h_elastic_x130_clone_xil);
		  hs_xil.Add(h_singlediss_clone_xil);
		  THStack hs_xir("hs_xir","");
		  hs_xir.Add(h_elastic_x130_clone_xir);
		  hs_xir.Add(h_singlediss_clone_xir);
